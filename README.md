...
- [fxsjy/jieba](https://github.com/fxsjy/jieba) - 结巴中文分词 (2 days ago)
- [FranzKafkaYu/x-ui](https://github.com/FranzKafkaYu/x-ui) - Lightweight xray panel with multi-protocol and multi-user on the same port,support English with telegram bot.  (2 days ago)
- [peng-zhihui/HoloCubic](https://github.com/peng-zhihui/HoloCubic) - 带网络功能的伪全息透明显示桌面站 (3 days ago)
