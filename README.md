...
- [ProfFan/Snap2LaTeX](https://github.com/ProfFan/Snap2LaTeX) - A minimalist macOS app to convert a snap of Equation to LaTeX without paying :shrug: (4 weeks ago)
...
- [haierkeys/fast-note-sync-service](https://github.com/haierkeys/fast-note-sync-service) ([3.5.1](https://github.com/haierkeys/fast-note-sync-service/releases/tag/3.5.1), 1 day ago) - High-performance, low-latency note synchronization, online management, and remote REST API service platform.
